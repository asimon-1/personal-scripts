...
# Following https://tkdocs.com/tutorial/
...
meterframe.grid(column=2, row=2, sticky=(tkinter.N, tkinter.W, tkinter.E, tkinter.S))
meterframe['borderwidth'] = 2
meterframe['relief'] = 'sunken'


feet_entry = ttk.Entry(mainframe, width=7, textvariable=feet)
feet_entry.grid(column=2, row=1, sticky=(tkinter.W, tkinter.E))

ttk.Label(meterframe, textvariable=meters).grid()
